        ...
        else
        {
            for(int i=a; i<b+1; i++)
            {
                if(current_array[i][c] == '=' || current_array[i][c] == '+' || current_array[i][c] == '-'||current_array[i][c] == 'x'||current_array[i][c] == '÷')
                {
                    ...
                    location++;
                    if(x-y>1) // condition for checking '03' type of terms
                    {
                    ...
                    numbers[index] = number_x(y,x-1,c,current_array); // function to build number
                    index++;
                    y = x+1;
                    //   negative_integer = false;
                }
            }
            if(b-y+1>1) // condition for checking '03' type of terms
            {
                if(current_array[y][c]==0)
                {
                    return false;
            ...
            numbers[index] = number_x(y,b,c,current_array); // function to build number
        }
        ...
        else
        {
            for(int i=c; i<d+1; i++)
            {
                if(current_array[a][i] == '=' || current_array[a][i] == '+' || current_array[a][i] == '-'||current_array[a][i] == 'x'||current_array[a][i] == '÷')
                {
                    ...
                    numbers[index] = number_y(y,x-1,a,current_array); // function to build number
                    index++;
                    y = x+1;
                }
            }
            if(d-y+1>1) // condition for checking '03' type of terms
            {
                if(current_array[a][y]==0)
                {
                    return false;
            ...
            numbers[index] = number_y(y,d,a,current_array); // function to build number
        }
